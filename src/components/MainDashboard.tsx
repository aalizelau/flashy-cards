  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div className="flex-1 px-8 py-12 max-w-4xl mx-auto">
        {/* Welcome Section */}
        <div className="mb-12">
          <div className="bg-gradient-to-r from-orange-100 to-pink-100 rounded-3xl p-8 relative overflow-hidden">
            ...
            <div className="absolute right-8 top-1/2 transform -translate-y-1/2">
              <div className="flex space-x-4">
                ...
                <div className="w-16 h-20 bg-pink-400 rounded-lg"></div>
              </div>
            </div>
          </div>
        </div>
            ...
            >
              <CardContent className="p-6 h-full flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-daily-challenges-foreground/80 mb-6">
