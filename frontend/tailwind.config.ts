	...
	theme: {
		...
		extend: {
			...
			colors: {
				...
				'home-gray-beige': 'hsl(var(--home-gray-beige))',
				'home-gray-beige-bg': 'hsl(var(--home-gray-beige-bg))',
				'home-gray-neutral-bg': 'hsl(var(--home-gray-neutral-bg))',
				'home-gray-blue-bg': 'hsl(var(--home-gray-blue-bg))',
				'home-gray-green-bg': 'hsl(var(--home-gray-green-bg))',
